...
def run_analysis(facilities_df, roads_df, lga_boundary, outpatient_files, population_tif):
    try:
        # --- DATA ACQUISITION & MELTING (From Notebook) ---
        all_data = []
        ...
        # --- SPATIAL ANALYSIS (Healthcare Deserts) ---
        ...
        # --- MORAN'S I (Hotspot Analysis from Notebook) ---
        # Aggregate by LGA for the most recent year
